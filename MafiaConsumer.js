...
const strategyx = [
     ...
     'Repetição de 8x Coluna 1',
     'Repetição de 8x Coluna 2',
     'Repetição de 8x Coluna 3',
...
const spectStrategy = [
     ...
     'Repetição de 7x Coluna 1',
     'Repetição de 7x Coluna 2',
     'Repetição de 7x Coluna 3',
     'Impar 11 vezes',
     'Par 11 vezes'
...
async function sendMsg(sala, msg) {
          ...
          async function saveMemorySend(sygnalBase, string) {
               ...
               const msg2 = await sendMsg(-1150553286, string)
               const msg = await sendMsg(-1593932898, string)
