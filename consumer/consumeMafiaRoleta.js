...
const strategyx = [
     'Repetição de 12 vezes do Primeiro Bloco',
     'Repitição de 12 vezes do Segundo Bloco',
     'Repitição de 12 vezes do Terceira Bloco',
     'Repetição de 12 vezes da Primeira Coluna',
     'Repetição de 12 vezes da Segunda Coluna',
     'Repetição de 12 vezes da Terceira Coluna',
...
const spectStrategy = [
     'Repetição de 11 vezes do Primeiro Bloco',
     'Repitição de 11 vezes do Segundo Bloco',
     'Repitição de 11 vezes do Terceira Bloco',
     'Repetição de 11 vezes da Primeira Coluna',
     'Repetição de 11 vezes da Segunda Coluna',
     'Repetição de 11 vezes da Terceira Coluna',
